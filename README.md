...
The value of this game is focused on that it is fun and entertaining, that it is easy to use and very accessibility. The game is fairly simple and takes minimal skill to play as each round (especially when played against a computer), it is more a game of chance than skill. Therefore, its the perfect game to entertain children and fans of the show. The point fo the game is for the player to have the ability to unwind, relax and have some fun; its value lies in its ability to improve ones quality of life through entertainment.
